...
export const BookOpenIcon = ({ id }: { id: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mb-1 mx-auto" fill="none" viewBox="0 0 24 24" strokeWidth={2}>
        <defs>
            <linearGradient id={`fire-gradient-${id}`} x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#FF8C00" />
                <stop offset="50%" stopColor="#D62929" />
...
export const DocumentTextIcon = ({ id }: { id: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mb-1 mx-auto" fill="none" viewBox="0 0 24 24" strokeWidth={2}>
        <defs>
            <linearGradient id={`fire-gradient-${id}`} x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#FF8C00" />
        ...
        <path stroke={`url(#fire-gradient-${id})`} strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
    </svg>
);

export const PhoneIconForBar = ({ id }: { id: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mb-1 mx-auto" viewBox="0 0 20 20">
        <defs>
            <linearGradient id={`fire-gradient-${id}`} x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#FF8C00" />
                <stop offset="50%" stopColor="#D62929" />
        ...
        <path fill={`url(#fire-gradient-${id})`} d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
    </svg>
);