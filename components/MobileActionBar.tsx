            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-around items-center h-16">
                    <button 
                        ...
                        className="flex flex-col items-center text-center text-primary-yellow hover:text-white transition-colors duration-200 p-2"
                        aria-label="Inquire about catering"
                    >
                        <DocumentTextIcon id="bar-catering" />
